...
WHERE DATE(Session.date) >= '$currentDate' AND Genre_idGenre = 2";
        ...
        <?php $theaters = array_map("unserialize", array_unique(array_map("serialize", $theaters))); ?>
        <?php foreach ($theaters as $theater) { ?>
            <div class="container-fluid">
                <div class="row">
                <div class="col-2"></div>
                    <div class="col-lg-4">
                        <img src="Cover/<?php echo $theater['cover']; ?>" class="img-fluid">
                    </div>
                    <div class="event col col-lg-4">
                        <h1><?php echo $theater['event']; ?></h1>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="col">
                            <form class="btn-position-right" method="GET" action="product.php" name="product">
                                <input type="hidden" name="idEvent" value="<?php echo $theater["idEvent"];?>" />
